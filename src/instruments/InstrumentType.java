...
public enum InstrumentType {
    ...
    XYLOPHONE       ("xylophone", 109, Sound.BLOCK_NOTE_BLOCK_XYLOPHONE),
    ...
    BIT             ("bit", 113, Sound.BLOCK_NOTE_BLOCK_BIT),
    BANJO           ("banjo", 114, Sound.BLOCK_NOTE_BLOCK_BANJO),
    PLING           ("pling", 115, Sound.BLOCK_NOTE_BLOCK_PLING);
    ...
    public static InstrumentType getInstrumentTypeByItemStack(ItemStack itemStack) {
        ...
        for(InstrumentType instrumentType : InstrumentType.values()) {
            ...
            if(holder.has(key, PersistentDataType.DOUBLE)) return instrumentType;
        }
    ...
    public static InstrumentType getInstrumentTypeByKey(String key) {
        for(InstrumentType instrumentType : InstrumentType.values()) {
            if(instrumentType.getKey().equals(key)) return instrumentType;
        }
